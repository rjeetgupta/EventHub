...
const roleConfig = {
  student: {
    ...
    nav: [
      ...
      ["Explore Events", "/student/events", LayoutGrid],
      ["My Registrations", "/student/registrations", ClipboardList],
      ["My Bookmarks", "/student/bookmarks", Heart],
      ["Clubs & Groups", "/student/clubs", Users],
      ["Notifications", "/student/notifications", Bell],
      ["Profile", "/student/profile", CircleUserRound],
